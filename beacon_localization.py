...
class RobotLocationBeacon:
    def __init__(self, x: float = 0, y: float = 0):
        ...
        self.device_positions = {
            ...
            "FC:CC:D6:C3:D1:4A": (1.9020336866378784, 1.0856691598892212, 0.6161160469055176), #sargazoldmarkerezett
            "CF:C9:25:A0:81:53": (0.45428064465522766, 1.9725672006607056, 0.5662478804588318), #bordo15
            "E0:68:8A:9D:06:A2": (-1.4703487157821655, 1.0286478996276855, 0.7123057246208191),#rozsaszin14es
        }
        ...
        # Load target devices
        self.TARGET_DEVICES = self.load_target_devices("beacons.txt")
