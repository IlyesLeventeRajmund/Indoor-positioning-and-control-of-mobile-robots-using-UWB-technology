...
file_path = "saturation_measures/measures/m20_saturation.json"
...
plt.savefig("plot_m20_1_Po.png", dpi=300, bbox_inches="tight")
plt.close()
...
plt.xlim(x_min, x_max)
plt.ylim(y_min, y_max)
plt.savefig("plot_m20_2_Pb.png", dpi=300, bbox_inches="tight")
plt.close()
...
plt.grid()
plt.legend()
plt.savefig("plot_m20_3_Xo_vs_time.png", dpi=300, bbox_inches="tight")
plt.close()
...
plt.grid()
plt.legend()
plt.savefig("plot_m20_4_Yo_vs_time.png", dpi=300, bbox_inches="tight")
plt.close()
...
plt.grid()
plt.legend()
plt.savefig("plot_m20_5_Xb_vs_time.png", dpi=300, bbox_inches="tight")
plt.close()
...
plt.grid()
plt.legend()
plt.savefig("plot_m20_6_Yb_vs_time.png", dpi=300, bbox_inches="tight")
plt.close()
